        ...
        <main class="form-registration">
            ...
            <form action="/register" method="post">
              ...
              <div class="form-floating">
                <input autofocus type="text"name="username" class="form-control @error('username') is-invalid @enderror" id="username" placeholder="Username" required value="{{ old('username') }}">
